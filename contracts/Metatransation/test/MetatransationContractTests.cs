...
namespace MetatransationTests
{
    ...
    public class MetatransationContractTests : IClassFixture<CheckpointFixture<MetatransationContractTests>>
    {
        ...
        public MetatransationContractTests(CheckpointFixture<MetatransationContractTests> fixture)
        {
